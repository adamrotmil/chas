...
def seed_tasks(session: Session, assets: Dict[str, Asset], graph: Dict[str, Any], voice: Dict[str, Any]) -> None:
    task_specs = [
        ...
        },
        {
            ...
            "reason_created": "Email body segment needs truth status, themes, and boundary notes.",
            "input_payload": {
                "segment_title": graph["segment"].title,
                "text": graph["segment"].text_content,
            },
            "required_decisions": ["segment_boundary_good", "segment_title", "people", "themes", "truth_status"],
        },
        {
        ...
        },
        {
            ...
            "required_decisions": ["voice_mode", "authenticity_value", "voice_density", "usable_for_voice_context"],
        },
        {
